...
#
# sigmadelta_decimator_filter.tcl: Tcl script for re-creating project 'sigmadelta_decimator_filter'
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/cic_top_v0.vhd"]"\
...
set _xil_proj_name_ "sigmadelta_decimator_filter"
...
set script_file "sigmadelta_decimator_filter.tcl"
...
set file "$origin_dir/src/cic_top_v1.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/cic_core_v0.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/cic_top_v0.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
if {[string equal [get_filesets -quiet sim_csv] ""]} {
  create_fileset -simset sim_csv
}

# Set 'sim_csv' fileset object
...
# Set 'sim_csv' fileset file properties for remote files
set file "$origin_dir/src/tb/top_tb_csv.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_csv] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj


# Set 'sim_csv' fileset file properties for local files
# None
